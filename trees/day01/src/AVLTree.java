...
//            int height = Math.max(height(root), 0);
            return balance(n);
        }
        return null;
    }
...
//        update height
//        n.rightChild.height = Math.max(height(n.rightChild.leftChild), height(n.rightChild.rightChild)) +1;
        n.height = 1 + Math.max(height(n.leftChild), height(n.rightChild));
...
//   update height
//        n.leftChild.height = Math.max(height(n.leftChild.leftChild), height(n.leftChild.rightChild)) +1;
        n.height = 1 + Math.max(height(n.leftChild), height(n.rightChild));
        y.height = 1 + Math.max(height(y.leftChild), height(y.rightChild));
        return y;
    }
